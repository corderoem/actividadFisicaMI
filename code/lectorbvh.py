...
class Bvh:
    ...
    def plot_hierarchy(self):
        ...
        print("Visualizando la animación...")
    
        for i in range(anim.frames):
            print(f"Visualizando el fotograma {i + 1}/{anim.frames}")
            anim.plot_frame(i, fig, ax)

        print("Mostrando la animación completa...")
    ...
    def parse_motion(self, text):
        ...
        for line in lines:
            ...
            if line.startswith("Frame Time:"):
                ...
                # Si desea fijar la tasa de FPS a 100
                self.fps = 100
                continue
...
if __name__ == '__main__':
    ...
    anim = Bvh()
    # parser file
    anim.parse_file("ejemplos/testhlt1.bvh")

    # draw the skeleton in T-pose
    #Descomentar para vissualizar la animación completa
    #anim.plot_hierarchy()

    # extract single frame pose: axis0=joint, axis1=positionXYZ/rotationXYZ
    #p, r = anim.frame_pose(10)
